...
const Login = () => {
  ...
  return (
    <section className="container px-5 lg:px-0">
      <div className="w-full max-w-[570px] mx-auto rounded-lg shadow-md md:p-10">
        ...
        <form className="py-4 md:py-0" onSubmit={submitHandler}>
          ...
          <div className="mb-5">
            <input type="password" placeholder='Enter Your Password' name='password' value={formData.password} onChange={handleInputChange} className='w-full py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px] leading-7 text-headingColor placeholder:text-textColor  cursor-pointer' required/>
          </div>
