...
const Profile = ({doctorData}) => {
    ...
    useEffect(()=>{
        ...
        qualifications:doctorData?.qualifications,//index 0
    ...
    const handleReusableInputChangeFunc = (key, index, event) =>{
        ...
        setFormData(prevFormData =>{
            const updatedItems = [...prevFormData[key]]; // Correctly create a copy of the array
                ...
                <div className="grid grid-cols-3 gap-5 mb-[30px]">
                    ...
                    <div>
                        ...
                        <select name="specialization" value={formData.specialization} onChange={handleInputChange} className="form_input py-3.5">
                            ...
                            <option value="eurologist">Eurologist</option>
                            <option value="dermatologist">Dermatologist</option>
                        </select>
                    </div>

                    <div>
                        <p className="form_label">Visit Fee*</p>
                            ...
                            <div>
                                <div className="grid grid-cols-2 gap-5">
                                    <div>
                                        ...
                                        <input type="date" name="startingDate" value={item.startingDate} className="form_input" onChange={event => handleQualificationChange(event, index)}/>
                                    </div>
                                    <div>
                                        <p className="form_label">Ending Date*</p>
                                        <input type="date" name="endingDate" value={item.endingDate} className="form_input" onChange={event => handleQualificationChange(event, index)}/>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-5">
                                    <div>
                                        ...
                                        <input type="text" name="degree" value={item.degree} className="form_input" onChange={event => handleQualificationChange(event, index)}/>
                                    </div>
                                    <div>
                                        <p className="form_label">University*</p>
                                        <input type="text" name="university" value={item.university} className="form_input" onChange={event => handleQualificationChange(event, index)}/>
                                    </div>
                                </div>
                        ...
                        <div key={index}>
                            <div>
                                <div className="grid grid-cols-2 gap-5">
                                    <div>
                                        <p className="form_label">Starting Date*</p>
                                        <input type="date" name="startingDate" value={item.startingDate} className="form_input" onChange={event => handleExperienceChange(event, index)}/>
                                    </div>
                                    <div>
                                        <p className="form_label">Ending Date*</p>
                                        <input type="date" name="endingDate" value={item.endingDate} className="form_input" onChange={event => handleExperienceChange(event, index)}/>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-5">
                                    <div>
                                        ...
                                        <input type="text" name="position" value={item.position} className="form_input" onChange={event => handleExperienceChange(event, index)}/>
                                    </div>
                                    <div>
                                        <p className="form_label">Hospital*</p>
                                        <input type="text" name="hospital" value={item.hospital} className="form_input" onChange={event => handleExperienceChange(event, index)}/>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                                    <div>
                                        ...
                                        <select name="day" value={item.day} className="form_input py-3.5" onChange={event => handleTimeSlotChange(event, index)}>
                                            <option value="">Select</option>
                                    ...
                                    <div>
                                        ...
                                        <input type="time" name="startingTime" value={item.startingTime} className="form_input" onChange={event => handleTimeSlotChange(event, index)}/>
                                    </div>
                                    <div>
                                        <p className="form_label">Ending Time*</p>
                                        <input type="time" name="endingTime" value={item.endingTime} className="form_input" onChange={event => handleTimeSlotChange(event, index)}/>
                                    </div>
                                    <div className="flex items-center">
                                        <button className="bg-red-600 p-2 rounded-full text-white text-[18px] cursor-pointer mt-6" onClick={e=>deleteTimeSlot(e,index)}><AiOutlineDelete/></button>
                                    </div>
                                </div>
                            </div>
                        </div>
